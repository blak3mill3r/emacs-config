(custom-set-variables
 ...
 '(evil-collection-mode-list
   '(2048-game ag alchemist anaconda-mode apropos arc-mode auto-package-update beginend bm bookmark
               ...
               (indent "indent")
               indium info ivy js2-mode leetcode log-edit log-view lsp-ui-imenu lua-mode kotlin-mode macrostep man magit magit-todos markdown-mode minibuffer monky mpdel mu4e mu4e-conversation neotree newsticker notmuch nov omnisharp org-present osx-dictionary outline p4
 ...
 '(safe-local-variable-values
   '((magit-todos-exclude-globs "platform/resources/public/js/compiled/**/*" "platform/node_modules/**/*")
     (eval progn
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((((class color) (min-colors 89)) (:foreground "#839496" :background "#002b36" :height 150)))))
